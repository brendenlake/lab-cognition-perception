...
# 
# <center>
#     <b>Table 1</b>: The relationship between the scales of measurement and the discrete/continuity distinction. Cells with a tick mark correspond to things that are possible.
# </center>
# 
...
# 
# 
# - [Introduction to psychological measurement](#introduction-to-psychological-measurement). What does it mean to operationalise a theoretical construct? What does it mean to have variables and take measurements?
# - [Scales of measurement and types of variables](#scales-of-measurement). Remember that there are *two* different distinctions here: there's the difference between discrete and continuous data, and there's the difference between the four different scale types (nominal, ordinal, interval and ratio). 
# - [Reliability of a measurement](#assessing-the-reliability-of-a-measurement). If I measure the "same" thing twice, should I expect to see the same result? Only if my measure is reliable. But what does it mean to talk about doing the "same" thing? Well, that's why we have different types of reliability. Make sure you remember what they are.
# - [Terminology: predictors and outcomes](#the-role-of-variables-predictors-and-outcomes). What roles do variables play in an analysis? Can you remember the difference between predictors and outcomes? Dependent and independent variables? Etc. 
# - [Experimental and non-experimental research designs](#experimental-and-non-experimental-research). What makes an experiment an experiment? Is it a nice white lab coat, or does it have something to do with researcher control over variables?
# - [Validity and its threats](#confounds-artifacts-and-other-threats-to-validity). Does your study measure what you want it to? How might things go wrong? And is it my imagination, or was that a very long list of possible ways in which things can go wrong? 
# 
# 
# 
