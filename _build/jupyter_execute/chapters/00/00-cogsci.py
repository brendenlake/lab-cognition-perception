...
# # What is Cognitive Science and how do we study it?
...
# 
# Now, planning for the future like this is a critical part of current machine learning systems.  For example, recently Google developed a system that can play the game "Go" as well as world champions {cite}`Silver:2016aa`.  This algorithm also uses the concept of planning.  Thus a central question is how humans use planning to think about and decide courses of action.  There is a [great Netflix movie](https://www.youtube.com/watch?v=WXuK6gekU1Y) about the drama of building a computer to beat the world champion at Go.
...
# <iframe width="560" height="315" src="https://www.youtube.com/embed/N3hUOJ-rUzQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
# 
# **James DiCarlo** - Reverse engineering visual intelligence
# <iframe width="560" height="315" src="https://www.youtube.com/embed/Sc8-3XD3bDw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
# 
# **Linda Smith** - Word Learning From the Infant's Point of View
# <iframe width="560" height="315" src="https://www.youtube.com/embed/_v-M5H67FQI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
# 
# 
